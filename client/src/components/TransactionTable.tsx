...
import { formatDate } from '../helpers/data.helper.ts';
import { formatToUSD } from '../helpers/currency.helper.ts';
import { instance } from '../api/axios.api.tsx';
...
const TransactionTable: FC<ITransactionTable> = ({ limit = 3}) => {
  ...
  return (<>
    <ReactPaginate
      ...
      activeClassName='bg-blue-600 rounded-sd'
      pageLinkClassName='text-white text-x5 py-1 px-2 rounded-sm'
